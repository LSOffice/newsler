        ...
        <View className='w-full justify-center items-center min-h-[90vh] px-4 flex flex-col'>
          <View className='flex flex-col gap-2 justify-center items-center'>
            ...
            <View className='flex flex-col justify-center items-center'>
              <Text className='text-xl text-center font-medium'>News reimagined, modernised</Text>
              <Text className='text-xl text-center font-medium'>exclusively on <Text className='text-xl font-medium text-primary'>Newsler</Text></Text>
            </View>
          ...
          >
            <Text className='text-white font-semibold text-lg'>Sign up with email</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
